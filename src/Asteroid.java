...
public class Asteroid extends CelestialObject{
	...
	//of the asteroid
	public Asteroid(double xPos, double yPos, double xVel, double yVel, String colour, double mass, String name, int radius) {
